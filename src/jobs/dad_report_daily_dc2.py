"""
DAD Report Daily 30 31 603 DC2 - Production Job.
...
class DadReportDailyDc2Job(ETLJobBase):
    """DAD Report Daily 30 31 603 DC2 job."""

    SCHEDULE_TYPE = "daily"
    OUTPUT_FORMAT = "xlsx"
    FILE_PATH = "./data/reports"
    FILENAME_TEMPLATE = "DAD_Daily_Report_Leadtime_Productivity_DC2_${DATE}"
    TEMP_PATH = "./temp"
    ...
    # SQL_54 = "src/sql/dc2_report/opcode_54.sql"
    SQL_31 = "src/sql/dc2_report/opcode_31.sql"
    SQL_603 = "src/sql/dc2_report/opcode_603.sql"
    SQL_OPCODE = "src/sql/dc2_report/opcode.sql"
    SQL_SORTPLAN_603 = "src/sql/dc2_report/sortplan_603.sql"
    SQL_OPCODE_30_SC = "src/sql/dc2_report/opcode_30_sc_to_dc.sql"
    # SQL_OPCODE_45 = "src/sql/dc2_report/opcode_45.sql"
    ## newly added for dc report
    SQL_OPCODE_30_DC = "src/sql/dc2_report/opcode_30_dc_to_sc.sql"
    SQL_OPCODE_31_DC = "src/sql/dc2_report/opcode_31_dc_to_sc.sql"
    ...
    def process(self):
        ...
        self.logger.info("Executing load_data sheet (opcodes 30, 31, 618, 603) for DC2")
        ...
        self.logger.info("DAD Report Daily 30 31 603 DC2 job completed successfully")
